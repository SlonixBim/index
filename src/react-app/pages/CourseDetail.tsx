...
export default function CourseDetailPage() {
  ...
  useSEO({
    title: course
      ? `${course.title} Course | Slonix Solutions`
      : "Course Details | Slonix Solutions",
    description: course
                ...
                <div className="space-y-4">
                  {course.curriculum.map((module, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="border-2 border-gray-100 rounded-xl overflow-hidden hover:border-red-200 transition-colors"
                      >
                        <button
      ...
      <section className="py-20 px-6 relative bg-gradient-to-r from-red-600 to-red-500">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-xl text-red-100 mb-8 leading-relaxed">
            Join thousands of successful students who have launched their
            careers with Slonix Solutions
          </p>
          <Link
            to={`/enroll/${course.id}`}
