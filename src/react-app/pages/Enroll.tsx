...
export default function EnrollPage() {
  ...
  useSEO({
    title: course ? `Enroll in ${course.title} | Slonix Solutions` : "Enroll Now | Slonix Solutions",
    description: course ? `Enroll in ${course.title} at Slonix Solutions. ${course.duration} hands-on training program. Fill the form and our team will contact you within 24 hours.` : "Enroll in an engineering course at Slonix Solutions today.",
    canonical: course ? `https://slonix.in/enroll/${course.id}` : "https://slonix.in/enroll",
  });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 pb-12 border-b border-white/10">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex items-center gap-3">
                <a href="https://www.instagram.com/slonix_solutions" target="_blank" rel="noopener noreferrer" title="Instagram" className="w-9 h-9 rounded-full flex items-center justify-center hover:scale-110 transition-all" style={{ background: "rgba(255,255,255,0.08)" }}>
                ...
                <a href="https://www.linkedin.com/company/slonix-solutions/" target="_blank" rel="noopener noreferrer" title="LinkedIn" className="w-9 h-9 rounded-full flex items-center justify-center hover:scale-110 transition-all" style={{ background: "rgba(255,255,255,0.08)" }}>
